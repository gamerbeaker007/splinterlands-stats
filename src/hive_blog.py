...
def get_last_season_earnings_table(last_season):
    ...
    result += "| SPS modern | " + sps_icon + " " + str(round(last_season.sps_modern, 3)) + " |\n"
    result += "| SPS wild | " + sps_icon + " " + str(round(last_season.sps_wild, 3)) + " |\n"
    result += "| SPS focus | " + sps_icon + " " + str(round(last_season.sps_focus, 3)) + " |\n"
